...
class D4PG():
    ...
    def __init__(self, state_size, action_size, seed, device, LR_ACTOR=1e-4, LR_CRITIC=1e-4, WEIGHT_DECAY=0.0001):
        ...
        self.critic_local = CriticD4PG(state_size, action_size, seed, n_atoms=N_ATOMS, v_min=Vmin, v_max=Vmax).to(
            device)
        self.critic_target = CriticD4PG(state_size, action_size, seed, n_atoms=N_ATOMS, v_min=Vmin, v_max=Vmax).to(
            device)
